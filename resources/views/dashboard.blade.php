        ...
        <main class="main-content">
            <div class="container">
                ...
                <div class="page-header">
                    <div>
                        <span class="page-eyebrow">{{ Auth::user()->role === 'bibliotecario' ? 'Administração' : 'Área do leitor' }}</span>
                        <h2>Olá, {{ Auth::user()->name }} 👋</h2>
                    </div>
                    <a href="/livros" class="btn btn-primary">Acessar Catálogo de Livros ➔</a>
                </div>
                ...
                @if(Auth::user()->role === 'bibliotecario')
                    ...
                    <div class="card">
                        <h3 class="card-title">📥 Realizar Novo Empréstimo</h3>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if($emp->status_multa == 'pendente')
                                                    <span class="badge badge-danger">Multado</span>
                                                @elseif($emp->status_multa == 'sem_multa' && $emp->data_devolucao)
                                                    <span class="badge badge-success">No Prazo</span>
                                                @else
                                                    <span class="badge" style="background-color: #eef1f4; color: #55606b;">Em Aberto</span>
                                                @endif
                                            </td>
